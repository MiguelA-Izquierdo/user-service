...
public class UserLogoutDomainEvent implements Event<UserLogoutDomainEvent.UserPayload> {

  private static final Logger logger = LoggerFactory.getLogger(UserLogoutDomainEvent.class);
  ...
  public UserLogoutDomainEvent(String userExchange,
